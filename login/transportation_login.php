...
<head>
    ...
    <link rel="stylesheet" href="transportation_login.css" >
</head>
<body>
    <header>
    ...
    <form action="../index.php" method="POST">
        ...
        <center><input type="submit" name="login" id="login-btn" value="Login" /></center>
    </form>


        <div class="links">Don't have an account? 
            <a href="../signup/transportation_signup.php" id="create">Create Account</a> <br>
